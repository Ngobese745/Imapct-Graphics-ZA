...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
          ...
          child: Form(
            ...
            child: ConstrainedBox(
              constraints: BoxConstraints(
                minHeight: ResponsiveUtils.getScreenHeight(context) - MediaQuery.of(context).padding.top - MediaQuery.of(context).padding.bottom,
              ),
              child: IntrinsicHeight(
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        SizedBox(height: isMobile ? 32 : isTablet ? 48 : 64),
                        CustomLogo(size: isMobile ? 80 : isTablet ? 100 : 120),
                    ...
                    Container(
                      ...
                      margin: isTablet || isDesktop ? const EdgeInsets.symmetric(horizontal: 20) : EdgeInsets.zero,
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: Theme.of(context).brightness == Brightness.dark ? Colors.black.withOpacity(0.3) : Colors.black12,
                            blurRadius: 20,
                            offset: const Offset(0, 8),
                          ),
                        ],
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              border: OutlineInputBorder(
                                ...
                                borderSide: BorderSide(color: Theme.of(context).brightness == Brightness.dark ? Colors.white30 : Colors.black12),
                              ),
                              ...
                              filled: true,
                              fillColor: Theme.of(context).brightness == Brightness.dark ? const Color(0xFF1A1A1A) : Colors.white,
    ...
    setState(() {
                    ...
                    SizedBox(height: isMobile ? 24 : isTablet ? 40 : 48),
                  ],
                ),
              ),
            ),
      ...
      body: SafeArea(
        ...
        child: Column(
              ...
              children: [
                ...
                Column(
                  children: [
                    SizedBox(height: isMobile ? 20 : isTablet ? 40 : 60),
                    CustomLogo(size: isMobile ? 80 : isTablet ? 100 : 120),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: OutlinedButton.icon(
                              ...
                              icon: const Icon(FontAwesomeIcons.facebook, size: 18),
...
class _UpdatesScreenState extends State<UpdatesScreen> {
  final List<UpdateItem> _updates = [
    ...
    UpdateItem(
      ...
      message: 'You\'ve earned 50 loyalty points for your recent project completion.',
      type: UpdateType.loyalty,
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildUpdateCard(update, isMobile);
                    },
                  ),
                ),
              ],
  ...
  Widget _buildUpdateCard(UpdateItem update, bool isMobile) {
    return Container(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: ResponsiveUtils.getBodyFontSize(context),
                              fontWeight: update.isRead ? FontWeight.w500 : FontWeight.bold,
                              color: Theme.of(context).brightness == Brightness.dark 
                                  ? Colors.white 
                                  : Colors.black87,
                            ),
...
class _DashboardScreenState extends State<DashboardScreen> {
                ...
                SliverToBoxAdapter(
                  child: _currentIndex == 0 
                      ? Padding(
                        ...
                        Row(
                          children: [
                            Expanded(child: _buildSmallServiceCard('Leasing', 'Gadgets & Equipment', Icons.phone_android)),
                            const SizedBox(width: 12),
                            Expanded(child: _buildSmallServiceCard('Development', 'Apps & Websites', Icons.grid_view)),
                            const SizedBox(width: 12),
                            Expanded(child: _buildSmallServiceCard('My Orders', 'Track & Manage', Icons.receipt_long)),
                          ],
                        ),
                        const SizedBox(height: 32),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  'Your preferred service • 2 active projects',
                  style: TextStyle(
          ...
          Center(
            child: Column(
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  'Payment of R299 due after trial • Enjoy premium benefits!',
                  style: TextStyle(
                    color: Theme.of(context).brightness == Brightness.dark
                        ? Colors.white70
                        : Colors.black54,
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: const Text(
                                          'Silver Tier',
                                          style: TextStyle(color: Color(0xFF8B0000), fontSize: 11, fontWeight: FontWeight.w600),
                                        ),
                                      ),
                                      TextButton(
                                        onPressed: () {
  ...
  Widget _buildDrawerItem({
    ...
    final Color resolvedIconColor = iconColor ?? Colors.white70;
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: [
              Colors.white.withOpacity(Theme.of(context).brightness == Brightness.dark ? 0.04 : 0.25),
              Colors.white.withOpacity(Theme.of(context).brightness == Brightness.dark ? 0.01 : 0.12),
            ],
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
          ),
        ...
        child: Row(
          children: [
            ...
            if (trailing == null)
              Icon(Icons.chevron_right, color: resolvedIconColor),
          ],
        ),
      ),
    );
